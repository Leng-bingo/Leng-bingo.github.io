...
! function (e, t) {
	...
	return function (e) {
		...
		t.DEFAULT_EMOJI_CDN = "//img.t.sinajs.cn/t4/appstyle/expression/ext/normal/", t.DB_NAME = "Comment", t.defaultConfig = {
			...
			appKey: "",
			clazzName: "Comment",
			master: ["a0d6a3a11b9d00e23f3231b11f1df4b3"],
			friends: ["ac09bd93643cfb386bcf08841f7683ba"],
			tagMeta: ["博主小冷", "小伙伴", "访客"],
			metaPlaceholder: {
				"nick": "昵称/QQ号(必填)",
				"mail": "邮箱(必填)",
